...
{ 	Matriz2 = array [1 .. 5418,5419 .. 10836] of string;		     
  ...
  ListaProms = array [1..12972] of PalProm;

  ListaBool = array [1 .. 12972] of boolean;
 ...
 var i : integer;
  ...
  function stringdeColores(palabra1, palabra2 : Palabra):string;
   ...
   begin 
	  Lista.tope := 0;
	  AssignFile(tfIn, 'palabrasENG.txt');
  ...
  begin
    ...
    { generarMatriz1(Lista,matrizcol1); }
    { generarMatriz2(Lista,matrizcol2); }
    { generarMatriz3(Lista,matrizcol3); }
    { generarMatriz4(Lista,matrizcol4); }
    { guardartxtMatriz(matrizcol4,tfOut); }
    ...
    imprimirPalabra(mejorPalabra(listprom,lb)); }
    While s1 <> 'FIN' do
    begin
